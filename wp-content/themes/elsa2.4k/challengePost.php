<div id="post-<?php the_ID(); ?>" class="row thePost challengePost postFormat">
	<div class="authorColumn small-4 small-centered large-uncentered large-6 medium-4 columns">
		...
		<h2 class="authorTitle"><a href="<?php the_field('sponsor_url'); ?>"><?php the_field('sponsor_name') ?></a></h2>
	</div>
